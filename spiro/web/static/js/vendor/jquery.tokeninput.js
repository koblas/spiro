/*
 *   https://github.com/manuelbernhardt/jquery-tokeninput/blob/33fa8e0a157212cc0d1d736a5fc44a0092914bc4/src/jquery.tokeninput.js
 *
...
$.TokenList = function (input, url_or_data, settings) {
    ...
    if($.type(url_or_data) === "string") {
        ...
        settings.data_function = url_or_data;
    ...
    function add_token (item) {
        ...
        if(settings.allowCreation && item.wasCreated) {
            item.name = item['_saved_val_']; // restore the name without the token creation text
        }
    ...
    function run_search(query) {
        ...
        if(cached_results) {
            ...
            if(settings.url) {
                ...
                var results;
                if(settings.data_function) {
                    results = settings.data_function(query);
                } else {
    ...
    function handleCreation(results) {
        ...
        displayedItem['_saved_val_'] = input_box.val();
        displayedItem[settings.tokenValue] = item[settings.tokenValue];
