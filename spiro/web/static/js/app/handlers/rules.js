...
function (app, $, _, Backbone, Models) {
    ...
    var View = Backbone.Distal.View.extend({
        ...
        initialize: function() {
            ...
            $('#leftbar .nav #leftbar_rules').addClass('active');
        },
        ...
        on_submit: function(evt) {
            ...
            var model = new Models.Rules.Model(vals);
            model.save()
    ...
    Handler.Controller = function () {
        ...
        layout.main.show(new View({ collection: app.data.rules }));
    };

    app.router.route("rules", "rules", Handler.Controller);
